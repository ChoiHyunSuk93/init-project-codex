...
- 적용 대상에는 [`AGENTS.md`](../../AGENTS.md), `rule/`, `docs/guide/`, [`docs/implementation/AGENTS.md`](../../docs/implementation/AGENTS.md), [`subagents_docs/AGENTS.md`](../../subagents_docs/AGENTS.md), cycle 문서가 포함된다.
