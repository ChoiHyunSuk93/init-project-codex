...
- 적용 대상에는 [`AGENTS.md`](../../AGENTS.md), [`PROJECT_OVERVIEW.md`](../../PROJECT_OVERVIEW.md), `rule/`, `docs/guide/`, [`docs/implementation/AGENTS.md`](../../docs/implementation/AGENTS.md), [`subagents_docs/AGENTS.md`](../../subagents_docs/AGENTS.md), [`subagents_docs/roadmap.md`](../../subagents_docs/roadmap.md), cycle 문서가 포함된다.
...
- cycle 문서의 경로, header, section provenance는 [`rule/rules/cycle-document-contract.md`](cycle-document-contract.md)를 따른다.
