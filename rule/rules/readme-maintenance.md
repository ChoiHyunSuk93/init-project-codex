...
- 상세 요구사항과 phase 계획은 [`PROJECT_OVERVIEW.md`](../../PROJECT_OVERVIEW.md)와 [`subagents_docs/roadmap.md`](../../subagents_docs/roadmap.md)로 연결하고, README에 중복해서 길게 풀지 않는다.
...
- 프로젝트 목적이나 사용 방법이 아직 구체적이지 않다면 초기 template에는 안전한 marker를 사용할 수 있지만, 초기화 완료 전에는 확인된 사실 또는 명시적인 미확정 설명으로 교체한다.
...
- 탐색에 도움이 되면 [`AGENTS.md`](../../AGENTS.md), [`PROJECT_OVERVIEW.md`](../../PROJECT_OVERVIEW.md), [`rule/index.md`](../index.md), [`subagents_docs/roadmap.md`](../../subagents_docs/roadmap.md), [`docs/guide/README.md`](../../docs/guide/README.md), [`docs/implementation/AGENTS.md`](../../docs/implementation/AGENTS.md) 같은 관련 진입 문서를 [`README.md`](../../README.md)에서 연결한다.
