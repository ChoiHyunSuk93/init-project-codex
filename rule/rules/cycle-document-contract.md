...
- [`docs/implementation/AGENTS.md`](../../docs/implementation/AGENTS.md) 아래의 `docs/implementation/`은 evaluator `PASS` 이후 새 최종 브리핑을 남기는 이력 계층이며 working record를 대체하지 않는다.
