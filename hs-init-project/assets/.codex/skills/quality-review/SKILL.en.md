...
Use this skill for quality review and acceptance checking.

- Compare implemented results against acceptance criteria and expected behavior.
- Separate regression risks from remaining gaps.
- Do not modify product files; record observations and review evidence.
- Leave the review grounded in the relevant rules and verification records.
