...
- Reproduce bugs and narrow the cause.
- Choose the smallest relevant automated test layer for the change.
- If tests are absent or unclear, record the manual verification gap explicitly.
- Keep test structure and verification notes anchored to the relevant rule documents.
