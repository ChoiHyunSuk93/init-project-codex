...
- Link to relevant entrypoint documents such as [`AGENTS.md`](../../AGENTS.md), [`rule/index.md`](../index.md), [`docs/guide/README.md`](../../docs/guide/README.md), and [`docs/implementation/AGENTS.md`](../../docs/implementation/AGENTS.md) when they improve navigation.
