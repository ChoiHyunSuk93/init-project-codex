...
- root `AGENTS.md`의 저장소 전용 내용은 OMX가 생성한 기본 계약 위에 얹는 overlay로 유지한다.
...
- 저장소가 OMX-managed `.codex/skills/` 위에 프로젝트 전용 skill을 추가한다면 설명, metadata, invocation policy를 서로 맞춘다.
