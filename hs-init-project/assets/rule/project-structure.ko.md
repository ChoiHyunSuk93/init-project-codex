...
- 단일 application은 명확한 source root를 유지할 수 있지만 monorepo와 multi-runtime 저장소에는 여러 의도적인 source area를 허용한다.
...
- package/workspace 설정, build/test 진입점, import 관계, 기존 문서를 함께 확인한다.
