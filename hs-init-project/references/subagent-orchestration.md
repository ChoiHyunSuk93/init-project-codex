...
Generated repositories must include `docs/guide/subagent-workflow.md` as the user-facing explanation of this flow.
...
6. After a subagent output is integrated and the thread is no longer needed, the coordinator closes that thread instead of leaving stale sessions open.
