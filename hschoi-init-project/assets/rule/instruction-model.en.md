...
- Put repository-wide implementation quality expectations into `rule/development-standards.md` or a narrower local rule instead of scattering them across multiple instruction files.
